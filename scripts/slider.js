...
export default async function createSlider(block) {
 ...
 if (dir === 'rtl') {
 document.querySelector('.next')?.style && (document.querySelector('.next').style.right = 'auto');
 document.querySelector('.prev')?.style && (document.querySelector('.prev').style.right = 'auto');
 document.querySelector('.next')?.style && (document.querySelector('.next').style.left = '0');
 document.querySelector('.prev')?.style && (document.querySelector('.prev').style.left = '0');
 }
 ...
 if (moveLeftBtn) moveLeftBtn.disabled = disableLeftBtn;
 if (moveRightBtn) moveRightBtn.disabled = disableRightBtn;
 } catch (e) {
